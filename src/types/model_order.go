...
type Order struct {
	...
	Provider *AllOfOrderProvider `json:"provider,omitempty"`
	...
	Billing *AllOfOrderBilling `json:"billing,omitempty"`
	// The fulfillments involved in completing this order
	Fulfillments []Fulfillment `json:"fulfillments,omitempty"`
	// The cancellation details of this order
	Cancellation *AllOfOrderCancellation `json:"cancellation,omitempty"`
	...
	Quote *AllOfOrderQuote `json:"quote,omitempty"`
	...
	Xinput *AllOfOrderXinput `json:"xinput,omitempty"`
