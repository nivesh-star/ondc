...
type AllOfFulfillmentRating string
...
type Fulfillment struct {
	...
	Rating AllOfFulfillmentRating `json:"rating,omitempty"`
	...
	State AllOfFulfillmentState `json:"state,omitempty"`
	...
	Customer AllOfFulfillmentCustomer `json:"customer,omitempty"`
	// The agent that is currently handling the fulfillment of the order
	Agent AllOfFulfillmentAgent `json:"agent,omitempty"`
